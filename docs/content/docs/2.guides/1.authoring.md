...
When two files must agree on geometry — a table header and its body rows —
put the column widths in one shared module and read them from both sides.
The playground invoice shows this pattern in
