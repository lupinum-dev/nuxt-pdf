...
description: The pdf.* configuration for font declarations, the remote allowlist, and render limits.
icon: lucide:sliders
---
...
[Images & fonts]($docs/guides/images-and-fonts).
...
Import these types from `@lupinum/nuxt-pdf` when application code shares module
configuration:
