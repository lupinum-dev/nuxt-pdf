...
| Prop | Type | Description |
| ---- | ---- | ----------- |
| `size` | `PdfPageSizeName \| [w, h] \| { width, height }` | A known uppercase page name, or explicit numeric/unit dimensions (`pt`, `in`, `mm`, `cm`, `px`). See [Page sizes]($docs/reference/page-sizes). |
...
| Prop | Type | Description |
| ---- | ---- | ----------- |
| `href` | `string` | The link target (required): an external `https:` or `mailto:` URL, or a `#id` internal destination |
