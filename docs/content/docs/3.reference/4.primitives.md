...
| `fill` | `string` | Direct SVG text paint colour |
...
| ---- | ---- |
| `fill`, `stroke` | `string` |
| `fillOpacity`, `strokeOpacity` | `PdfSvgLength` (0–1 or 0%–100%) |
| `strokeWidth` | `PdfSvgNumber` (non-negative) |
| `strokeLinecap` | `'butt' \| 'round' \| 'square'` |
| `strokeLinejoin` | `'miter' \| 'round' \| 'bevel'` |
| `transform` | `PdfSvgTransform` — one to three unitless `translate(...)` / `rotate(...)` operations |
