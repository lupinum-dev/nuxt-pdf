...
description: Bundle local PNG, JPEG, TTF, and OTF resources with a PDF template.
icon: lucide:image
---
...
Put a TTF or OTF file in `pdfs/fonts`, then register one entry for each weight
...
- **Structure:** images must decode as PNG or JPEG; fonts need a valid TTF or
  OTF structure and matching extension.
